...
private val DarkColorScheme = darkColorScheme(
    ...
    secondaryContainer = RewardGoldDark,
    onSecondaryContainer = RewardGoldLight,
    tertiary = RewardGoldLight,
    tertiaryContainer = SettingsLavenderDark,
    onTertiaryContainer = SettingsLavenderTextDark,
...
private val LightColorScheme = lightColorScheme(
    ...
    tertiary = RewardGold,
    tertiaryContainer = SettingsLavender,
    onTertiaryContainer = SettingsLavenderText,
